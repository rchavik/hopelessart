			...
			<div id="footer">
				...
				<div id="footerinformation" class="grid_16">
					...
					<div id="poweredby" class="grid_8 grid_8_left">
						<p>Powered by <?php echo $this->Html->link('Croogo', 'http://croogo.org'); ?> with <?php echo $this->Html->link('HopelessArt', 'http://hopelessart.com/blog/hopelessart-theme'); ?> Theme</p>
					</div>
					<!-- end poweredby -->
